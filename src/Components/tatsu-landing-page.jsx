...
<div  className='flex text-xl items-center text-center  	'>
  <div  className=' ajsnasjaskoj		mr-1 bg-black text-white'>SUBSCRIBE TO THE PLANS TO GRAB AMAZING DISCOUNTS AND OFFERS</div>
  <div className='  	ajsnasjaskoj bg-black text-white' >SUBSCRIBE TO GET BUY ONE GET ONE DISCOUNTS AND MANY MORE</div>
</div>

<div   className="h-40 	justify-center notYouTyp	flex-col items-center	  flex bg-black text-white  mt-1">
  <span  className='text-xl'>VIP MEMBERSHIP OFFERS</span>
  <span  className='text-2xl'>BUY ONE, GET TWO FREE T-SHIRTS</span>
...
<section id="landing-page-sec5">
    <div class="container">
        ...
        <div class="row  nmflsd">
            <div class="nmnsd  mr-8 every-obsessed">
